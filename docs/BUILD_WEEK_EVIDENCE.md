...
- Judge archive: `release/Codeville-0.1.0-mac-arm64.zip` (134 MB), rebuilt 2026-07-18 15:20 PT from the full command-center build: scaffold isolation, Site Inspection landing, dual-register debriefs, salience, ledger, work orders, wall mode, mid-turn `turn/steer` redirects, failed-session scaffold recovery, chimes/props, and the willow-ward scenery pass. Packaged E2E (deterministic + one real session) passed against this exact `.app`; the five-project packaged gate is re-run at final freeze.
- SHA-256: `74180fbbfd2b4a7f07301de47f7536ddff894a82a1a4b78f10e708c70827014c`.

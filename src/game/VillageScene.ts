...
function phaseLabel(phase: SessionPhase): string {
  return ({ idle: 'Ready', starting: 'Builder arriving', planning: 'Planning', reading: 'Reading', editing: 'Building', testing: 'Testing', approval: 'Needs approval', completed: 'Improvement complete', failed: 'Construction paused', interrupted: 'Ready' })[phase];
}
